...
export const copy = {
  am: {
    ...
    receiptHelp: "የክፍያ ማረጋገጫዎን እዚህ ይጫኑ",
    location: "አድራሻ",
    phone: "ስልክ ቁጥር",
    requirements: "መስፈርቶች",
    details: "ዝርዝር",
    ...
    preparingPost: "ማስታወቂያዎ በመዘጋጀት ላይ...",
    postPublished: "ማስታወቂያው ታትሟል",
    ...
    submittingPayment: "የክፍያ ጥያቄዎ በመላክ ላይ...",
    ...
    loadListingsFailed: "ማስታወቂያዎችን መጫን አልተቻለም",
    loadMyAdsFailed: "የኔን ማስታወቂያዎች መጫን አልተቻለም",
